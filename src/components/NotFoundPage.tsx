...
const NotFoundPage: React.FC = () => (
    <div
        className="flex flex-col items-center gap-4 justify-center h-screen p-10 text-center"
        role="main"
    ...
    >
        ...
        <a
            ...
            className="text-blue-500 no-underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 hover:underline"
